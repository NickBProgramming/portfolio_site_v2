...
const FormInput = memo(({
  ...
  <motion.div
    ...
    transition={{ delay: id === "name" ? 0.5 : id === "email" ? 0.6 : 0.7 }}>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <motion.div variants={itemVariants}>
          ...
          <div className="space-y-4 mb-6">
            <ContactInfoItem icon={Mail} label="Email" value="nickbprogramming@gmail.com" />
          ...
          <motion.div className="mt-8" variants={itemVariants}>
            ...
            <div className="flex gap-4">
              <SocialIcon
                href="https://github.com/NickBProgramming"
                icon={Github}
                index={0}
                hoverBg="#333"
              ...
              <SocialIcon
                href="https://www.linkedin.com/in/nbprogramming/"
                icon={Linkedin}
                index={1}
                hoverBg="#0077b5"
                hoverColor="rgba(0, 119, 181, 0.5)" />
              ...
              {/* <SocialIcon
                ...
                index={2}
                hoverBg="#1DA1F2"
                hoverColor="rgba(29, 161, 242, 0.5)" /> */}
            </div>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 text-white font-medium py-2 px-4 rounded-lg transition-colors"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 0.8 }}
              whileHover={{ scale: 1.03, boxShadow: "0 5px 15px rgba(239, 68, 68, 0.4)" }}
              whileTap={{ scale: 0.97 }}>
              {isSubmitting ? (
                <>
                  <div
                    className="animate-spin w-5 h-5 border-2 border-white border-t-transparent rounded-full"></div>
                  <span>Sending...</span>
                </>
              ) : (
                <>
            ...
            <AnimatePresence>
              {submitStatus === "success" && (
                <motion.div
                  className="mt-4 p-3 bg-green-900 bg-opacity-50 text-green-300 rounded-lg"
              ...
              {submitStatus === "error" && (
                <motion.div
                  className="mt-4 p-3 bg-red-900 bg-opacity-50 text-red-300 rounded-lg"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}>
